...
type GreetServiceClient interface {
	SayHelloUnary(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloResponse, error)
...
func (c *greetServiceClient) SayHelloUnary(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/greet_service.GreetService/SayHelloUnary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	SayHelloUnary(context.Context, *NoParam) (*HelloResponse, error)
...
func (UnimplementedGreetServiceServer) SayHelloUnary(context.Context, *NoParam) (*HelloResponse, error) {
...
func _GreetService_SayHelloUnary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NoParam)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).SayHelloUnary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet_service.GreetService/SayHelloUnary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SayHelloUnary(ctx, req.(*NoParam))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _GreetService_SayHelloUnary_Handler,
		},
	},
